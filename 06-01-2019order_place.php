	...
	$flag = 0;
	 if(!empty($_SESSION['login'])){
        ...
        if(($k_lock == '1') && ($discount != '')){
            $test_method = mysqli_query($conn, "INSERT INTO order_list SET product_id='$pro_id',user_id='$u_id',merchant_id='$m_id',quantity='$qty_list',product_code='$p_code',amount='$p_price',remark='$option',location='".$location."',table_type='".$table_type."',created_on='$date'");
