    ...
    <div id="wrapper" class="wrapper">
        ...
        <div class="content-wrapper">
            ...
            <!-- /.site-sidebar -->
                    ...
                    <?php
                    $categories = mysqli_query($conn, "SELECT DISTINCT(products.category) FROM products WHERE user_id ='".$id."' and status=0 ORDER BY created_date DESC");
                    if($product['pro_ct'] > 0) { ?>
                    ...
                    <div class="col-md-4  <?php echo $row['category'];?>" >
                    ...
                    <img src="<?php echo $site_url; ?>/images/product_images/<?php echo $row['image'];  ?>" width="100%" height="170px" class="make_bigger">
                    </a>
                    ...
                    { ?>
                    <img src="https://upload.wikimedia.org/wikipedia/commons/a/ac/No_image_available.svg" width="100%" height="170px" class="make_bigger">
                    <?php }
                    ?></div>
...
<?php } ?>
  ...
  <script>
	...
	$(".oth_pr").on("click", function(){
		$("#test").append("<tr>  <td><button type='button' class='removebutton'>X</button> </td><td><input style='width:70px;' type=text name='qty[]'><input type= hidden name='p_price[]' value='0' ></td> <td><input style='width:70px;' type=text name='p_code[]' id='test_code'</td> <td><input style='width:70px;' type= text name='p_id[]'></td><td> <textarea name='option[]'></textarea></td>  </tr>");
	});
