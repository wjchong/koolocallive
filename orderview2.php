            ...
            <div class="row" id="main-content" style="padding-top:25px">
                <div class="well">
                    ...
                    <div>
                        ...
                        <span style="cursor: pointer; color:blue;text-decoration:underline;font-size: 40px;" id="scan_order"><?php echo $language['scan_order'];?></span> &nbsp;&nbsp;&nbsp;&nbsp;<span style="cursor: pointer; color:green;text-decoration:underline;font-size: 40px;" id="scan_order1">Table/combine bill</span>
                    ...
                    <table class="table table-striped">
                        ...
                        <tr id="<?php echo $row['invoice_no']; ?>" class="<?php echo $todayorder; ?> fdfd <?php echo $callss; ?>" data-id="<?php echo $row['id']; ?>">
                            ...
                            <td>
							  <?php if($row['auto_print']=='1'){ ?>
                                <a class="print-order" href="#" data-id="<?php echo $row['id']; ?>" data-invoice="<?php echo $row['invoice_no']; ?>">Print Receipt</a>
							  <?php } else { ?>
							     <a class="print-order" style="color:red;" href="#" data-id="<?php echo $row['id']; ?>" data-invoice="<?php echo $row['invoice_no']; ?>">
								 <blink>Print Receipt</blink>
								</a>
							  <?php } ?>
                            </td>
                                ...
                                <div class="modal-content" style="border-radius: 4px;background-color: transparent;    padding: 0px;">
                                    ...
                                    <div style="background-color: #6dafe2;padding: 10px;">
                                        ...
                                        <div class="inline fields">
                                            ...
                                            <div style="display: inline-block;">
                                                <label style="display: inline-block;height: 35px;">Invoice Number :</label>
                                                <input type="text" id="Invoice_num" class="invoice_num"  autofocus style="display: inline-block;height: 35px;">
                                                <button style="background-color: red;" data-toggle="modal" data-target="#myModal" id="invoice">Invoice</button>
                                            </div>
                                             
                                            <div style="display: inline-block;">
                                                &nbsp;
                                                <label style="display: inline-block;">Table Number :</label>
                                                <input type="text" id="barcode" class="table_num" autofocus style="display: inline-block;height: 35px;">
                                                <button style="background-color: green;" data-toggle="modal" data-target="#myModalt" id="table">Table</button>
                                            </div>
                                            <div style="display: inline-block;">
                                                <button style="background-color: #99e1dc;width:161px;height:50px;" id="add_invoice">Add</button>
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                        <div class="col-sm-8" style="float: left;">
                                            <form id="form" style="" method="POST" target="_blank" action="statement.php">
                                             <?php
                                           ...
                                           <input type="hidden" name="merchant_ses" id="merchant_ses" value="<?php echo $_SESSION['login'];?>">
                                            ...
                                            <div style="padding-top: 5px;    display: flex;">
                                                <span style="font-size: 20px; width: 40%;    border: 1px solid;padding-left: 4px; border-bottom-left-radius: 2px; border-top-left-radius: 2px;">Total</span>
                                                <span id="total_qty" style="font-size: 20px; width: 30%;    border: 1px solid;padding-left: 4px; border-left: none;"></span>
                                                 <input type="hidden" name="tol_qty" id="tol_qty" value="">
                                                <span id="total_amount" style="font-size: 20px;width: 30%;        border: 1px solid;padding-left: 4px; border-left: none; border-bottom-right-radius: 2px; border-top-right-radius: 2px;"></span>
                                                 <input type="hidden" name="tol_mnt" id="tol_mnt" value="">
                                            </div>
                                            ...
                                            <div style="padding-top: 5px;    display: flex;">
                                                ...
                                                <input type="text" id="paid" class="amount" name="paid" value="0" style="background-color:#6dafe2; font-size: 20px; width: 30%;margin-left: 30%;border: 1px solid #555555 ;padding-left: 4px;">
                                            </div>
                                            <div style="padding-top: 5px;    display: flex;">
                                            ...
                                            <div class="modal-footer" style="padding-bottom:2px; border-top: none;padding: 0px;padding-top: 5px;">
                                               ...
                                               <input type="submit" style="width:200px;height:50px;background-color: #99e1dc;" value="Print">
                                ...
                                <div class="modal-content" style="width: 139%;">
                                    ...
                                    <form id ="data">
                                        <div class="modal-body" style="padding-bottom:0px;">
                                            <div class="col-sm-12">
                                                <div class="form-group" id="invoice_list"></div>
                                            </div>
                                        </div>
                            ...
                            <div class="modal-dialog modal-lg">
                                ...
                                <div class="modal-content">
                                    ...
                                    <form id ="data">
                                        <div class="modal-body" style="padding-bottom:0px;">
                                            <div class="col-sm-12">
                                                <div class="form-group" id="table_list"></div>
                                            </div>
                                        </div>
                                        <div class="modal-footer" style="padding-bottom:2px;">
                                           <!-- <button>Submit</button>-->
...
function printer() {
  ...
  var tol_qty=document.getElementById("tol_qty").value;  
  var tol_mnt=document.getElementById("tol_mnt").value;  
  var statementid=document.getElementById("statementid").value;  
...
var qtyno = $("input[name='qtyno[]']")
              .map(function(){return $(this).val();}).get(); 
   if (paid == '' || orderid == '' ) {
alert("Please complete payment process.");
}else{        
...
alert("Please complete payment process.");
  ...
  $('#myScanModal').on('hidden.bs.modal', function (e) {
  $(this)
    .find("#paid")
       .val('')
       .end()
        ...
        //vandhu
         ...
         $("#add_invoice").click(function() {
                 ...
                 $.ajax({
                        ...
                        success: function(data) {
                           ...
                           if( data != null ) {
                                ...
                                $("#scanned_data").find("tr").each(function () {
                                ...
                                if (flag == 1) {
                                  ...
                                  for( var i = 0 ; i < order['product_name'].length ; i ++ ) {
                                   ...
                                   var i=1;
                                    var list =
                                        '<tr><td style="text-align:center; padding-left: 5px;width: 8%;" >' + parseInt(document.getElementById("scanned_data").childElementCount + 1) + '</td>' +
                  ...
                  $('.num').click(function() { 
                    ...
                    $('body').on("dblclick", "input[name=invo]", function (){
                 ...
                 $.ajax({
                      ...
                      $('body').on("dblclick", "input[name=tbl]", function (){
                      var tbl = $(this).attr("value");
                          $('.table_num').val(tbl);
