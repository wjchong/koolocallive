...
//~ echo '</pre>';     
   ...
   if(isset($_POST['guest_login']))
   {
    ...
    //~ $sql = "SELECT COUNT(*) AS count from users where `user_roles` ='3'";
    //~ print_r($sql);
    		$order_total = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM `users` WHERE user_roles = '3'"));
    		//~ echo '<pre>';
//~ print_r($order_total);
//~ echo '</pre>';
							...
							<label>Mobile Number</label>
                              <div class="login-top">
                                 ...
                                 <div class="login-bottom login-bottom1">
                                    <div class="submit">
                                       <input type="submit" value="Confirm" name="guest_login" />
                                    </div>
                                 </div>
                                 <div class="login-bottom login-bottom1">
                                    <div class="Back">
                                     <a class="back_button" href="http://kooexchange.com/demo/view_merchant.php">Back</a>
                                    </div>
                                 </div>
                              </div>
                           </form>
