...
if(isset($_POST['submit'])) 
{
  ...
  if($invoice_no == NULL) $invoice_no = 1;
   ...
   //if($stl_key == $_SESSION['stl_key']) {
        $u_id = 0;
        $sql = "INSERT INTO order_list SET product_id='$pro_id', user_id='', merchant_id='$m_id', quantity='$qty_list', amount='$p_price',product_code='$p_code', remark='$option', location='".$location."', table_type='".$table_type."',created_on='$date', invoice_no='$invoice_no'";
   ...
   if(isset($_POST['guest_login']))
   {
      ...
      if($check_user != 0){
         ...
         //  header("location:login.php"); 
             ...
             $error .= "5 times free order is over. Please register .<br>";
         }
     ...
     <?php 
                     ...
                     <label>Mobile Number</label>
                              <div class="login-top">
                                 ...
                                 <input type="text" class="mobile_number" placeholder="Telephone Number " name="mobile_number"  />
                                 <br>
                           ...
                           <br>
                              ...
                              <?php if($guest_permission == "0"){?>
                                        <input type="submit" value="Confirm" name="guest_login" style="font-size: 20px;"/>
                                        <?php } else {?>
