...
if(isset($_POST['login']))
{
	...
	$cm =	$countrycode.''.$mobile_number;
 	...
 	function updateStatus($session_id){
 		$cm = $GLOBALS['cm'];
	...
	if(empty($error))
	{
		$user_row = mysqli_fetch_assoc(mysqli_query($conn, "SELECT id,isLocked,referral_id,name, mobile_number FROM users WHERE mobile_number='$cm' AND password='$password' AND user_roles = '$user_role'"));
                            ...
                            <div class="tab-1 resp-tab-content" aria-labelledby="tab_item-0">
                                ...
                                <div class="login-top">	
									...
									<input type="radio" name="user_role" value="2"> <?php echo $language["merchant"];?>
                                        ...
                                        <input type="password" name="password" class="password" placeholder="<?php echo $language["password"];?>" required="" />
