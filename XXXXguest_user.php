...
if(isset($_POST['submit'])) 
{
        ...
        $u_id = 0;
		$test_method = mysqli_query($conn, "INSERT INTO order_list SET product_id='$pro_id',user_id='',merchant_id='$m_id',quantity='$qty_list',amount='$p_price',product_code='$p_code',remark='$option',location='".$location."',table_type='".$table_type."',created_on='$date'");
...
//~ }
//~ $bank_data = mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM users"));
//~ echo '<pre>';  
//~ print_r($bank_data);    
//~ echo '</pre>';     
